...
function LanguageSelector({ hasAccess }: { hasAccess: boolean }) {
  ...
  const handleLanguageSelect = (langId: string) => {
    const accessibleLanguages = ["java", "javascript","typescript","python","go","rust", "cpp", "ruby" , "swift"];
    if (!hasAccess && !accessibleLanguages.includes(langId)) return;
          ...
          >
            ...
            <div className="max-h-[280px] overflow-y-auto overflow-x-hidden">
              {Object.values(LANGUAGE_CONFIG).map((lang, index) => {
               const isLocked = !hasAccess && lang.id !== "java" && lang.id !== "javascript" && lang.id!=="typescript" && lang.id!=="python"
               && lang.id!=="go"&& lang.id!=="rust"&& lang.id!=="cpp" && lang.id!=="csharp" && lang.id!=="ruby" && lang.id!=="swift";
