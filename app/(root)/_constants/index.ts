...
export const LANGUAGE_CONFIG: LanguageConfig = {
  javascript: {
    ...
    defaultCode: ` console.log("ComipleX"),`
  },
  typescript: {
    id: "typescript",
    label: "TypeScript",
